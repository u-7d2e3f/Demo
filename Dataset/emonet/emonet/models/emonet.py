...
class EmoNet(nn.Module):
    ...
    def forward(self, x, reset_smoothing=False):
        ...
        final_VA_features = final_features.view(batch_size, final_features.shape[1])
      
        final_features = self.emo_fc_2(final_VA_features)
        ...
        return{
            ...
            'va_256': final_VA_features  # 返回原始的 256 维特征向量 [cite: 576, 781]
        }
